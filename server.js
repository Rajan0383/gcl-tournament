...
class GCLEngine {
    ...
    // ============================================
    // STRIKE MANAGEMENT (NEW)
    // ============================================

    updateStrike(batsmanName, runsScored) {
        // If runs scored is ODD, strike changes (1, 3, 5)
    ...
    bowlerGuess(data) {
        ...
        if (result.isOut) {
            ...
            this.matchState.currentBatsmanName = battingTeam.currentBatsman;
            // Update strike for non-out runs (ODD = strike change)
    ...
    endInnings() {
        ...
        if (this.matchState.inning === 1) {
            ...
            // Reset strikers for new innings
